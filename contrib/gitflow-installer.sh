...
EXEC_FILES="git-flow"
SCRIPT_FILES="git-flow-init git-flow-feature git-flow-hotfix git-flow-staging git-flow-release git-flow-support git-flow-version gitflow-common gitflow-shFlags"
